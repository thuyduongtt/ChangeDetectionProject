...
parser.add_argument('-model_backend', help='Model used in the encoder part of the U-Net structures model',
                    default='resnet50')
...
def main(args):
    ...
    model.model.save(
        "/scratch/ruzicka/python_projects_large/ChangeDetectionProject_files/weightsModel2_" + model_txt + "_[" + kfold_txt + "].h5")
    ...
    evaluator.unified_test_report([model.model.model], dataset.test, validation_set=dataset.val,
